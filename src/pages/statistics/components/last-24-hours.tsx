import { ScrollArea, Container, Stack, Group, ThemeIcon, Divider, Text } from '@mantine/core';
import {
  IconBabyBottle,
  IconDroplet,
    ...
    <ScrollArea h="100%">
      <Container fluid w="100%" py="8px">
        <Stack gap="lg">
            ...
            <Group wrap="nowrap" align="start">
              ...
              <Stack gap="0" justify="space-between">
                <Group gap="xxs" align="end">
                  ...
                  <Text>{t('statistics-page-24-hours-bottle-title', { count: bottleAmount })}</Text>
                </Group>
                <Text size="sm">
                  <Trans
          ...
          {feedByBottle && (feedByBoob || poopTrackerEnabled || sleepTrackerEnabled) && <Divider />}
